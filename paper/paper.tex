...
These observations encode a wealth of information about the volcanic features on its surface.
    ...
    The methods we have developed are also directly applicable to the problem of mapping surfaces of stars and exoplanets. \href{https://github.com/fbartolic/volcano}{\color{linkcolor}\faGithub}
\end{abstract}
