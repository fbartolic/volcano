...
\begin{figure}[h!]
    ...
    \oscaption{InformationContent}{
        ...
        We compute the posterior variance for different kinds of mock observations of Io over
...
\begin{figure}[h!]
    ...
    \oscaption{pixels_vs_harmonics}{%
        Inferred Maximum A Posteriori (MAP) estimates of $l=20$ maps (second panel from the top) produced by fitting a mock light curve (third panel) which was generated from a simulated $l=30$ map consisting of a single bright spot (top panel). 
